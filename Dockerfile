...
# Configure Go proxy and modules
...
RUN set -x \
    ...
    && CGO_ENABLED=0 go build \
      -trimpath \
      -ldflags "-s -w -X github.com/delta10/error-pages/internal/appmeta.version=${APP_VERSION}" \
      -o /tmp/error-pages \
      ./cmd/error-pages/ \
...
LABEL \
    ...
    org.opencontainers.image.url="https://github.com/delta10/error-pages" \
    org.opencontainers.image.source="https://github.com/delta10/error-pages" \
    org.opencontainers.image.vendor="delta10" \
...
# with the `--help` flag or refer to the documentation at https://github.com/delta10/error-pages#readme
